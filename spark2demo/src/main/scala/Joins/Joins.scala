...
object Joins {
  def main(args: Array[String]): Unit = {
    ...
    val abbrevsFile = "C:\\data\\abbrevs-to-names.tsv"
    val abbrevs = Opt(
      name   = "abbreviations",
      value  = abbrevsFile,
    ...
    val options = CommandLineOptions(
      ...
      CommandLineOptions.inputPath("C:\\data\\kjvdat.txt"),
      abbrevs,
      CommandLineOptions.outputPath("C:\\data\\output\\kjv-joins"),
    ...
    try {
      ...
      //val verser = input.fullOuterJoin(abbrevs);
